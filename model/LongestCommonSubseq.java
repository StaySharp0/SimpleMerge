...
public class LongestCommonSubseq<T>{
	...
	// 	try {
	// 		FileReader inS = new FileReader(sp);
	// 		FileReader inT = new FileReader(tp);

	// 	ArrayList<String> s = new ArrayList<String>();
	// 	ArrayList<String> t = new ArrayList<String>();

	// 	StringBuilder tmpStrBl = new StringBuilder();
	// 	int tmpCh = 0;

	// 	while(inS != null && tmpCh != -1){
	// 		while( ( tmpCh = inS.read() ) != '\n'){
	// 			tmpStrBl.append((char)tmpCh);
	// 		}
	// 		tmpStrBl.append('\n');
	// 		s.add(tmpStrBl.toString());
	// 	}
	// 	tmpCh = 0;
	// 	while(inT != null && tmpCh != -1){
	// 		while( ( tmpCh = inT.read() ) != '\n'){
	// 			tmpStrBl.append((char)tmpCh);
	// 		}
	// 		tmpStrBl.append('\n');
	// 		t.add(tmpStrBl.toString());
	// 	}

	// 	LongestCommonSubseq<String> lcs = new LongestCommonSubseq<String>(s,t);
	// 	System.out.println(lcs.toString());
	// 	}
	// 	finally{
	// 		if(inS == )
